...
//	    Vector4f bottomColor = new Vector4f(0.5f, 0.35f, 0.1f, 1.0f);
	    ...
	    switch(n) {
	    	case 1: topColor = new Vector4f(0.2f, 0.2f, 0.3f, 1.0f);
	    		break;
	    	case 2: topColor = new Vector4f(0.4f, 0.6f, 0.6f, 1.0f);
	    		break;
	    	case 3: topColor = new Vector4f(0.7f, 0.8f, 0.9f, 1.0f);
	    		break;
	    	case 4: topColor = new Vector4f(1.0f, 0.9f, 0.8f, 1.0f);
	    		break;
	    	case 5: topColor = new Vector4f(0.7f, 0.6f, 0.5f, 1.0f);
	    		break;
	    	case 6: topColor = new Vector4f(0.4f, 0.3f, 0.2f, 1.0f);
    			break;
	    }
		...
		float vertices[] = {
     		  ...
     		  -cubeSize+coords.x, -cubeSize+coords.y, -cubeSize+coords.z,		topColor.x, topColor.y, topColor.z, topColor.w, //bottom right
     		  cubeSize+coords.x, -cubeSize+coords.y, -cubeSize+coords.z,		topColor.x, topColor.y, topColor.z, topColor.w, //bottom left
     		  cubeSize+coords.x, -cubeSize+coords.y, -cubeSize+coords.z,		topColor.x, topColor.y, topColor.z, topColor.w, //bottom middle
